...
$('.search-form form').submit(function(){
	$('#report-function-parameter-value-mapping-grid').yiiGridView('update', {
		data: $(this).serialize()
	});
	return false;
});
...
<h1>Manage Report Function Parameter Value Mappings</h1>
...
<?php $this->widget('zii.widgets.grid.CGridView', array(
	'id'=>'report-function-parameter-value-mapping-grid',
