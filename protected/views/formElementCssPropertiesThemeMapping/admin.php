...
$('.search-form form').submit(function(){
	$('#form-element-css-properties-theme-mapping-grid').yiiGridView('update', {
		data: $(this).serialize()
	});
	return false;
});
...
<h1>Manage Form Element Css Properties Theme Mappings</h1>
...
<?php $this->widget('zii.widgets.grid.CGridView', array(
	'id'=>'form-element-css-properties-theme-mapping-grid',
