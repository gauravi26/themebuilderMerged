...
class Departments extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('department_code, department_name, department_desc', 'length', 'max'=>255),			
                         array('department_code', /*department_name, department_desc'*/ 'unique'),
	...
	public function relations()
	{
		...
		return array(
			'courses' => array(self::HAS_MANY, 'Courses', 'department_name'),
			'faculties' => array(self::HAS_MANY, 'Faculty', 'department_id'),
		);
	}
