...
/**
 * This is the model class for table "report_function_mapping".
 *
 * The followings are the available columns in table 'report_function_mapping':
 * @property integer $id
 ...
 */
class ReportFunctionMapping extends CActiveRecord
{
	/**
	...
	{
		return 'report_function_mapping';
	}
	 ...
	 * @return ReportFunctionMapping the static model class
	 */
